...
const NIS2_MEASURES = [
  ...
  { id: "b", title: "Incident handling", level: "planned",
    probes: [], categories: [],
    note: "Incident-report scaffolding is on the roadmap." },
  ...
  { id: "d", title: "Supply-chain security", level: "partial",
    ...
    note: "JS dependency CVEs (Retire.js) and leaked third-party credentials. No SBOM/transitive yet." },
  { id: "e", title: "Secure acquisition, development & maintenance; vulnerability handling", level: "strong",
    probes: ["reachability", "endpoint-discovery", "openapi", "sensitive-files", "cors",
      "security-headers", "sqli", "ssti", "ssrf", "xss", "cmdi", "open-redirect",
  ...
  { id: "f", title: "Assessing the effectiveness of measures", level: "evidence",
    probes: [], categories: [],
    note: "Baseline diff and re-scan-to-verify give a repeatable effectiveness signal over time." },
