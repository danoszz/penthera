...
description: >
  ...
  Use when the user asks to scan, audit, harden, pentest, or review security of their
  own app, staging URL, localhost, or repo; generate SARIF for GitHub; diff against a
  baseline; or find hardcoded secrets before deploy. Do NOT use for targets without
...
allowed-tools: "Bash(node:*) Bash(npm:*) Bash(penthera:*) Read Write"
metadata:
  author: danoszz
  version: 1.0.0
  category: security
